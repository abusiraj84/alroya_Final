...
import 'package:alroya/model/contactUs.dart';
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      ...
                      if(_formKey.currentState.validate()){
                        ...
                        ApiService()
                          ..contactUs(c).then((value) {BotToast.showSimpleNotification(title: "تم إرسال الرسالة بنجاح ❤");HapticFeedback.heavyImpact();});
